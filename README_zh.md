...
在5个 Tabula Sapiens 器官上对细胞类型聚合表达谱进行5折交叉验证。金标准：CellChat + CellPhoneDB v5 共识，按统计显著性动态加权。

| 器官 | 细胞类型数 | 细胞对数 | Spearman ρ | Pearson r | RMSE | 评级 |
|-------|-----------|---------|-----------|----------|------|------|
| **肺** | 33 | 1089 | **0.9496** ± 0.0076 | 0.9500 | 0.0500 | 优秀 |
| **肝** | 23 | 529 | **0.9182** ± 0.0257 | 0.9334 | 0.0666 | 优秀 |
| **肾** | 11 | 121 | **0.8986** ± 0.0463 | 0.9273 | 0.0865 | 优秀 |
| **眼** | 33 | 1089 | **0.8898** ± 0.0224 | 0.8999 | 0.0558 | 优秀 |
| **胰** | 16 | 256 | **0.8372** ± 0.0392 | 0.8501 | 0.1061 | 优秀 |

### 指标说明

| 指标 | 说明 |
|--------|-------------|
| Spearman ρ | 与金标准互作强度的秩相关系数 |
| Pearson r | 与金标准的线性相关系数 |
| RMSE | 互作强度预测的均方根误差 |
| 评级 | ρ ≥ 0.7: 优秀, 0.5–0.7: 良好, 0.3–0.5: 中等 |

每折均报告 Bootstrap 95% 置信区间。最终结果为5折均值 ± 标准差。
...
| 互作热图 | 预测值 vs 真实值 |
|--------------------|-------------------|
| ![肾热图](result/kidney_cv/interaction_heatmap.png) | ![肾TvsP](result/kidney_cv/true_vs_predicted.png) |

#### 肝

| 互作热图 | 预测值 vs 真实值 |
|--------------------|-------------------|
| ![肝热图](result/liver_cv/interaction_heatmap.png) | ![肝TvsP](result/liver_cv/true_vs_predicted.png) |

#### 胰

| 互作热图 | 预测值 vs 真实值 |
|--------------------|-------------------|
| ![胰热图](result/pancreas_cv/interaction_heatmap.png) | ![胰TvsP](result/pancreas_cv/true_vs_predicted.png) |

#### 肺

| 互作热图 | 预测值 vs 真实值 |
|--------------------|-------------------|
| ![肺热图](result/lung_cv/interaction_heatmap.png) | ![肺TvsP](result/lung_cv/true_vs_predicted.png) |

#### 眼

| 互作热图 | 预测值 vs 真实值 |
|--------------------|-------------------|
| ![眼热图](result/eye_cv/interaction_heatmap.png) | ![眼TvsP](result/eye_cv/true_vs_predicted.png) |

每个器官的其他可视化结果（互作网络图、环形图、气泡图、流图、自分泌评分）请见 `result/{organ}_cv/` 目录。
